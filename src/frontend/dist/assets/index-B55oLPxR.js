...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background scanline", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        className: "sticky top-0 z-50 bg-card border-b border-border shadow-subtle",
        "data-ocid": "layout.header",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-9 h-9 flex items-center justify-center rounded-lg bg-primary/10 border border-primary/30 group-hover:border-primary/60 transition-colors-fast", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-5 h-5 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-none", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-black text-base tracking-tight text-foreground uppercase", children: "Maddox" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-xs tracking-widest text-muted-foreground uppercase", children: "Is That You?" })
                ] })
              ]
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/25", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3.5 h-3.5 text-primary animate-pulse-glow" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs font-bold text-primary uppercase tracking-wider", children: "Unblocked" })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", "data-ocid": "layout.main", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        className: "bg-card border-t border-border",
        "data-ocid": "layout.footer",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs font-mono", children: "Play anywhere · No download · No account needed" })
        ] })
      }
    )
  ] });
...
function GameCanvas({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 flex items-center justify-between px-4 py-2 bg-card border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              variant: "ghost",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-semibold uppercase tracking-widest", children: "Hub" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `arcade-title text-sm ${game2.accentClass}`, children: game2.title }) }),
          score !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-center gap-2",
              "data-ocid": "game.score_display",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-widest font-mono", children: "Score" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-mono font-bold text-lg ${game2.accentClass}`, children: score.toLocaleString() })
              ]
            }
          ),
          score === void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
const LS_KEY = "arcade_highscores";
...
function saveLocalHighScore(game2, score) {
  const current = loadLocalHighScores();
  if (score > current[game2]) {
    current[game2] = score;
...
function useSubmitScore() {
  ...
  return useMutation({
    ...
    onSuccess: (updated) => {
      queryClient2.setQueryData(["highScores"], updated);
    }
  });
}
const game$1 = GAMES.find((g) => g.id === "FlappyBird");
const CANVAS_W$2 = 480;
const CANVAS_H$2 = 640;
const GRAVITY$1 = 0.5;
const FLAP_FORCE = -10;
...
function drawGround(ctx) {
  ...
  ctx.fillRect(0, CANVAS_H$2 - GROUND_H, CANVAS_W$2, GROUND_H);
  ctx.strokeStyle = C_PIPE_BORDER;
  ctx.lineWidth = 2;
  ctx.beginPath();
  ctx.moveTo(0, CANVAS_H$2 - GROUND_H);
  ctx.lineTo(CANVAS_W$2, CANVAS_H$2 - GROUND_H);
  ctx.stroke();
  ctx.strokeStyle = "oklch(0.55 0.18 145 / 0.7)";
  ctx.lineWidth = 2;
  for (let i = 12; i < CANVAS_W$2; i += 22) {
    ctx.beginPath();
    ctx.moveTo(i, CANVAS_H$2 - GROUND_H);
    ctx.lineTo(i - 4, CANVAS_H$2 - GROUND_H - 8);
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(i, CANVAS_H$2 - GROUND_H);
    ctx.lineTo(i + 4, CANVAS_H$2 - GROUND_H - 8);
...
function drawPipe(ctx, x, gapY) {
  ...
  const botH = CANVAS_H$2 - GROUND_H - botY;
...
function drawScore(ctx, score) {
  ...
  ctx.fillText(String(score), CANVAS_W$2 / 2, 70);
  ctx.shadowBlur = 0;
}
function drawOverlay(ctx, phase, score, highScore) {
  ...
  if (phase === "idle") {
    ...
    ctx.shadowColor = C_GLOW;
    ctx.shadowBlur = 20;
    ctx.fillText("FLAPPY BIRD", CANVAS_W$2 / 2, CANVAS_H$2 / 2 - 60);
    ctx.shadowBlur = 0;
    ctx.font = "18px monospace";
    ctx.fillStyle = "oklch(0.8 0.1 295)";
    ctx.fillText("Click or SPACE to start", CANVAS_W$2 / 2, CANVAS_H$2 / 2 - 10);
    if (highScore > 0) {
      ctx.font = "14px monospace";
      ctx.fillStyle = "oklch(0.65 0.15 295)";
      ctx.fillText(`Best: ${highScore}`, CANVAS_W$2 / 2, CANVAS_H$2 / 2 + 25);
    }
  } else if (phase === "dead") {
    ...
    ctx.shadowBlur = 20;
    ctx.fillText("GAME OVER", CANVAS_W$2 / 2, CANVAS_H$2 / 2 - 70);
    ctx.shadowBlur = 0;
    ctx.font = "bold 28px monospace";
    ctx.fillStyle = C_SCORE;
    ctx.fillText(`Score: ${score}`, CANVAS_W$2 / 2, CANVAS_H$2 / 2 - 20);
    if (highScore > 0) {
      ctx.font = "18px monospace";
      ctx.fillStyle = "oklch(0.72 0.2 295)";
      ctx.fillText(`Best: ${highScore}`, CANVAS_W$2 / 2, CANVAS_H$2 / 2 + 20);
    }
...
function FlappyBird() {
  ...
  const pipeTimerRef = reactExports.useRef(0);
  const birdRef = reactExports.useRef({ y: CANVAS_H$2 / 2, vy: 0, angle: 0 });
  const pipesRef = reactExports.useRef([]);
  const syncHighScore = reactExports.useCallback(() => {
  ...
  const resetGame = reactExports.useCallback(() => {
    birdRef.current = { y: CANVAS_H$2 / 2, vy: 0, angle: 0 };
    pipesRef.current = [];
    scoreRef.current = 0;
    ...
    function loop() {
      ...
      if (phaseRef.current === "playing") {
        ...
        if (pipeTimerRef.current >= PIPE_INTERVAL) {
          ...
          const maxGapY = CANVAS_H$2 - GROUND_H - PIPE_GAP / 2 - 40;
          const gapY = minGapY + Math.random() * (maxGapY - minGapY);
          pipesRef.current.push({
            x: CANVAS_W$2 + PIPE_WIDTH,
            gapY,
            scored: false
          });
        }
        ...
        if (bird.y + BIRD_R >= CANVAS_H$2 - GROUND_H || bird.y - BIRD_R <= 0) {
          endGame();
        }
        for (const p of pipesRef.current) {
          const halfGap = PIPE_GAP / 2;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GameCanvas, { game: game$1, score, isPlaying: phase === "playing", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center w-full h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "canvas",
      {
        ref: canvasRef,
    ...
    phase === "dead" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    phase === "playing" && highScore > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
const MAX_SHOTS = 5;
const CANVAS_W$1 = 700;
const CANVAS_H$1 = 500;
const GRAVITY = 0.22;
...
function launchBall(angleDeg, power) {
...
function rectCollide(bx, by, obs) {
  const cx2 = Math.max(obs.x, Math.min(bx, obs.x + obs.w));
...
function drawScene(ctx, ball, hole, obstacles) {
  ctx.fillStyle = DARK_BG;
  ctx.fillRect(0, 0, CANVAS_W$1, CANVAS_H$1);
  ctx.strokeStyle = "oklch(0.2 0.02 265)";
  ctx.lineWidth = 0.5;
  for (let x = 0; x < CANVAS_W$1; x += 40) {
    ctx.beginPath();
    ctx.moveTo(x, 0);
    ctx.lineTo(x, CANVAS_H$1);
    ctx.stroke();
  }
  for (let y = 0; y < CANVAS_H$1; y += 40) {
    ctx.beginPath();
    ctx.moveTo(0, y);
  ...
  ctx.lineWidth = 2;
  ctx.strokeRect(2, 2, CANVAS_W$1 - 4, CANVAS_H$1 - 4);
  ...
  ctx.stroke();
  ctx.setLineDash([]);
  if ((ball == null ? void 0 : ball.trail) && ball.trail.length > 1) {
  ...
  if (ball == null ? void 0 : ball.active) {
...
function GolfOrbit() {
  ...
  const phaseRef = reactExports.useRef("aiming");
  const rafRef = reactExports.useRef(0);
  const holeRef = reactExports.useRef(makeHole(1));
  const obstaclesRef = reactExports.useRef(makeObstacles(1));
  const shotsLeftRef = reactExports.useRef(MAX_SHOTS);
  const [phase, setPhase] = reactExports.useState("aiming");
  const [shotsLeft, setShotsLeft] = reactExports.useState(MAX_SHOTS);
  const [score, setScore] = reactExports.useState(0);
  const [angle, setAngle] = reactExports.useState(45);
  const [power, setPower] = reactExports.useState(60);
  const [level, setLevel] = reactExports.useState(1);
  const submitScore = useSubmitScore();
  const renderLoop = reactExports.useCallback(() => {
    const canvas = canvasRef.current;
    if (!canvas) return;
    const ctx = canvas.getContext("2d");
    if (!ctx) return;
    ...
    if (phaseRef.current === "flying" && (ball == null ? void 0 : ball.active)) {
      ...
      if (ball.x + BALL_RADIUS > CANVAS_W$1) {
        ball.x = CANVAS_W$1 - BALL_RADIUS;
        ball.vx = -Math.abs(ball.vx) * BOUNCE_DAMPING;
      }
      ...
      if (ball.y + BALL_RADIUS > CANVAS_H$1) {
        ball.y = CANVAS_H$1 - BALL_RADIUS;
        ball.vy = -Math.abs(ball.vy) * BOUNCE_DAMPING;
      ...
      if (speed < 0.4 && ball.y + BALL_RADIUS >= CANVAS_H$1 - 1) {
        ball.active = false;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GameCanvas, { game: GAME_META, score, isPlaying: phase === "flying", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col items-center gap-4 w-full h-full justify-center py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "relative border-2 border-glow-gold rounded-lg overflow-hidden glow-gold",
        style: { width: CANVAS_W$1, height: CANVAS_H$1, flexShrink: 0 },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "canvas",
            {
          ...
          (phase === "aiming" || phase === "flying") && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          phase === "won" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "arcade-title text-glow-gold text-5xl", children: "Hole In!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-foreground text-xl", children: [
                  "Score:",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-glow-gold font-bold text-2xl", children: score })
                ] }),
          ...
          phase === "lost" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "absolute inset-0 flex flex-col items-center justify-center gap-4",
              style: { background: "oklch(0.08 0.01 265 / 0.85)" },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Out of Shots"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-muted-foreground text-sm", children: "The ball didn't reach the hole" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
    ...
    phase === "aiming" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-sm text-glow-gold w-10 text-right tabular-nums", children: [
                angle,
                "°"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "28", cy: "30", r: "3", fill: GOLD })
                ]
              }
            )
          ] }),
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      width: `${power}%`,
                      background: "linear-gradient(to right, oklch(0.55 0.14 80), oklch(0.82 0.18 80))",
...
function GameTile({
  ...
  const navigate = useNavigate();
  const delay = `${index2 * 80}ms`;
  const handlePlay = () => navigate({ to: game2.route });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: [
        ...
        "game-card-hover",
        game2.borderGlowClass,
        game2.glowClass,
        "animate-slide-in-up"
      ].join(" "),
      style: { animationDelay: delay },
      "data-ocid": `hub.game_card.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pt-5 pb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                className: `arcade-title text-2xl leading-tight ${game2.accentClass}`,
                children: game2.title
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: { animationDelay: `${index2 * 0.5}s` },
                children: game2.emoji
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: game2.description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-5 py-3 bg-muted/20 border-t border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "w-4 h-4 text-muted-foreground flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-widest font-mono", children: "Best" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: `font-mono font-bold text-xl ${game2.accentClass} truncate`,
                children: highScore > 0 ? highScore.toLocaleString() : "—"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              ...
              children: game2.controls.split("•")[0].trim()
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            onClick: handlePlay,
            "data-ocid": `hub.play_button.${index2 + 1}`,
            children: [
...
function Hub() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "hub.page",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 animate-slide-in-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "arcade-title text-4xl sm:text-5xl font-black text-foreground mb-3 animate-neon-flicker", children: "Maddox Is That You?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base max-w-xl mx-auto font-body", children: "Four games. Zero downloads. Unblocked. Pick your game and go." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden mb-10 border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm uppercase tracking-widest text-muted-foreground", children: "All-Time High Scores" }),
              isLoading ? GAMES.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-24 rounded" }, g.id)) : GAMES.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-foreground font-bold", children: (highScores == null ? void 0 : highScores[g.id]) ? highScores[g.id].toLocaleString() : "—" })
              ] }, g.id))
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: GAMES.map((game2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              GameTile,
              {
                game: game2,
                highScore: (highScores == null ? void 0 : highScores[game2.id]) ?? 0,
                index: i
              },
              game2.id
            ))
...
const BG_COLOR$1 = "oklch(0.1 0.015 265)";
...
function SnakeGame() {
  ...
  const navigate = useNavigate();
  const submitScore = useSubmitScore();
  const snakeRef = reactExports.useRef(initialSnake());
  const dirRef = reactExports.useRef("RIGHT");
  const nextDirRef = reactExports.useRef("RIGHT");
  const foodRef = reactExports.useRef(randomFood(snakeRef.current));
  const scoreRef = reactExports.useRef(0);
  const phaseRef = reactExports.useRef("idle");
  ...
  const draw = reactExports.useCallback(() => {
    ...
    snakeRef.current.forEach((seg, i) => {
      const alpha = i === 0 ? 1 : Math.max(0.35, 1 - i / snakeRef.current.length);
      ctx.shadowBlur = i === 0 ? 18 : 0;
      ctx.shadowColor = MAGENTA_GLOW;
      ctx.fillStyle = i === 0 ? MAGENTA : `oklch(0.72 0.28 340 / ${alpha.toFixed(2)})`;
      ctx.beginPath();
  ...
  const tick = reactExports.useCallback(() => {
    ...
    const reverse = cur === "UP" && next === "DOWN" || cur === "DOWN" && next === "UP" || cur === "LEFT" && next === "RIGHT" || cur === "RIGHT" && next === "LEFT";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GameCanvas, { game: SNAKE_META, score, isPlaying: phase === "playing", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    phase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center px-8 py-8 rounded-xl bg-card/90 border border-glow-magenta glow-magenta backdrop-blur-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-6xl mb-3", children: "🐍" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "arcade-title text-3xl text-glow-magenta mb-2", children: "SNAKE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6 max-w-xs", children: "Eat food to grow. Avoid walls and your own tail." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Arrow keys / WASD · Space to start" })
          ] })
        ] })
      }
    ),
    phase === "dead" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 flex flex-col items-center justify-center",
        "data-ocid": "snake.game_over_panel",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center px-8 py-8 rounded-xl bg-card/95 border border-glow-magenta glow-magenta backdrop-blur-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-5xl mb-2", children: "💀" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "arcade-title text-2xl text-glow-magenta mb-1", children: "GAME OVER" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs uppercase tracking-widest mb-3", children: "Final Score" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
...
function drawPlayer(ctx, p) {
  ...
  ctx.fillStyle = grad;
  ctx.fillRect(cx2 - 16, p.y + PLAYER_H - 10, 32, 24);
  ctx.restore();
  ctx.save();
  ...
  ctx.shadowBlur = 8;
  ctx.beginPath();
  ctx.arc(cx2, p.y + 12, 3, 0, Math.PI * 2);
  ctx.fill();
  ctx.restore();
}
function drawBullet(ctx, b) {
  ...
  const r2 = BULLET_W / 2;
  ctx.beginPath();
  ctx.roundRect(x, y, BULLET_W, BULLET_H, r2);
  ctx.fill();
  ctx.restore();
}
function drawEnemy(ctx, e) {
  const cx2 = e.x + ENEMY_W / 2;
  const cy = e.y + ENEMY_H / 2;
  ctx.save();
  const grad = ctx.createRadialGradient(cx2, cy, 0, cx2, cy, 28);
  ...
  ctx.shadowBlur = 10;
  ctx.beginPath();
  ctx.ellipse(cx2, cy + 4, ENEMY_W / 2, ENEMY_H / 2 - 4, 0, 0, Math.PI * 2);
  ctx.fill();
  ctx.stroke();
  ctx.beginPath();
  ctx.ellipse(cx2, cy - 2, ENEMY_W / 3, ENEMY_H / 3, 0, Math.PI, 0);
...
function SpaceShooter() {
  ...
  const rafRef = reactExports.useRef(0);
  const [uiPhase, setUiPhase] = reactExports.useState("idle");
  const [liveScore, setLiveScore] = reactExports.useState(0);
  ...
  const tick = reactExports.useCallback(() => {
    ...
    s.bullets = s.bullets.map((b) => ({ ...b, y: b.y - BULLET_SPEED })).filter((b) => b.y + BULLET_H > 0);
    ...
    for (const e of s.enemies) {
      ...
      if (e.x <= 0 || e.x + ENEMY_W >= W) e.dir *= -1;
    }
    ...
    const hitEnemies = /* @__PURE__ */ new Set();
    const hitBullets = /* @__PURE__ */ new Set();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      game,
      score: uiPhase === "playing" ? liveScore : uiPhase === "over" ? finalScore : void 0,
      isPlaying: uiPhase === "playing",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: W, height: H }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "canvas",
          {
            ref: canvasRef,
        ...
        uiPhase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "arcade-title text-3xl text-glow-cyan", children: "Space Shooter" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm text-center max-w-xs leading-relaxed", children: [
                "Destroy incoming alien saucers before they reach you.",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "Each saucer =",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-glow-cyan font-mono", children: "+10 pts" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 rounded border border-border bg-muted/20 font-mono text-xs text-muted-foreground text-center", children: "← → or A D to move  ·  Space / Click to fire" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  onClick: startGame,
        ...
        uiPhase === "over" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "arcade-title text-4xl text-glow-cyan", children: "GAME OVER" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-widest font-mono", children: "Final Score" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              submitScore.isSuccess && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
...
const hubRoute = createRoute({
  ...
  path: "/",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Hub, {}) })
});
