...
export class Backend implements backendInterface {
    ...
    async getAllHighScores(): Promise<Array<[GameName, bigint]>> {
    ...
    async getHighScore(arg0: GameName): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async submitScore(arg0: GameName, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
